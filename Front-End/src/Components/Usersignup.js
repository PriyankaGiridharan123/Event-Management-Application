...
function UserSignup() {
  ...
  const senddb=(e)=>{
    e.preventDefault()
    const details={age,email,phone,password,username}
    ...
    fetch("http://localhost:8080/usersignup/userpost",{
      method:"POST",
  ...
  <div className='container'>
    ...
    <form>
      ...
      <div className="input">
          <input type="text" placeholder="Phone" value={phone}  pattern="[0-9]+"
    ...
    <Link to="/userlogin">  <p>Already have an account? Sign in</p></Link>
  </div>
</div>
</div>
  )
